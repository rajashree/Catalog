...
public class TemperatureObjectReporter implements TemperatureInfo {
	...
	public void setTemperatureInC(double temperatureInC) {
		celciusReporter.setTemperature(Integer.parseInt(Double.toString(temperatureInC)));
	}

	public void setTemperatureInF(double temperatureInF) {
		celciusReporter.setTemperature(Integer.parseInt(Double.toString(temperatureInF)));
	}
