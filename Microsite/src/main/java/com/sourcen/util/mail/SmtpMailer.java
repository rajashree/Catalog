...
public class SmtpMailer {
	...
	private void retrieveSession() {
		...
		if (session == null) {
			...
			mailProps.setProperty(HOST, host);
			mailProps.setProperty(PORT, String.valueOf(port));
			mailProps.setProperty(DEBUG, String.valueOf(debugEnabled));
