...
public class SignUpAction extends SourcenActionSupport {
		...
		if (registrationManager.isEnabled())
			try {
				...
				msg.addRecipient(new EmailAddress(user.getUsername(), user
						.getEmail()));
				msg.addBccRecipient(new EmailAddress("Admin",
						this.registrationManager.getFeedbackMailFromAddress()));
				// msg.addBccRecipient(new
				// EmailAddress("Admin","rajashree.meganathan@sourcen.com"));
				msg.setSubject("Welcome to Accept Search!");

				String body = "Dear "
						+ user.getUsername()
						+ ",<br/><br/>Thank you for registering with Accept Search, a groundbreaking new service for gaining meaningful product insight from online consumer reviews, forums and blogs.<br/><br/>Here are your registration details:<br/><br/>Username:  "
						+ user.getUsername()
						+ "<br/>First Name: "
						+ user.getFirstName()
						+ "<br/>Last Name:"
						...
						+ "<br/>Email: "
						+ user.getEmail()
						+ "<br/><br/>Please click on the following link to return to the Accept Search login page:<br/>"
						+ getBaseUrl()
						+ "/login.htm<br/><br/>If you need help or have comments or suggestions, please email us at "
						+ this.registrationManager.getFeedbackMailFromAddress()
						+ ". We're always interested in feedback, so don't hesitate to send us your thoughts.<br/><br/>Sincerely,<br/>The Accept Search Product Team";
				...
				msg.setSender(new EmailAddress("Admin",
						this.registrationManager.getFeedbackMailFromAddress()));
