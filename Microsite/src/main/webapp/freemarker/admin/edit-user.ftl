	    ...
	    <div id="content">
	        ...
	        <ul>
	          ...
	          <@macroFieldErrors name="firstname"/>
		          ...
		          <ul class="sec3">
					           <li class="label-group"><@s.text name="label.user.role"/></li>
					           <li>
					            <label>
					            <input type="checkbox" checked="checked" value="0" name="role"/>
					            User</label>
					          </li>
					          <li>
					            <label>
					            <input type="checkbox" checked="checked" value="1" name="role"/>
					            Admin</label>
					          </li>
