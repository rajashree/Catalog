...
*/
		...
		_mceInsertAnchor : function(ui, v) {
			...
			ed.windowManager.open({
				url : tinymce.baseURL + '/themes/advanced/anchor.html',
		...
		_mceCharMap : function() {
			...
			ed.windowManager.open({
				url : tinymce.baseURL + '/themes/advanced/charmap.html',
		...
		_mceHelp : function() {
			...
			ed.windowManager.open({
				url : tinymce.baseURL + '/themes/advanced/about.html',
				width : 480,
				height : 380,
				inline : true
			}, {
		...
		_mceCodeEditor : function(ui, val) {
			...
			ed.windowManager.open({
				url : tinymce.baseURL + '/themes/advanced/source_editor.html',
