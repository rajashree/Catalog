            	...
            	<div class="parent_child">
                    ...
                    <!-- Navigations -->
                        <div class="navigation">
                            <ul>
                                <li><div class="inactive_link_a"><a href="./Index.ice" class="hover">Sign In</a></div></li>
                                <li class="pipe">|</li>
                                <li class="active_prv"><div class="inactive_link_a"><a href="./About.ice" class="hover">About</a></div></li>                                
                                <li class="bg_img"><div class="active_link">Sign Up</div></li>
                                <li class="active_next"><div class="inactive_link_b"><a href="blog.html" class="hover">Blog</a></div></li>
                                <li class="pipe">|</li>
                                <li><div class="inactive_link_c"><a href="./Help.ice" class="hover">Help</a></div></li>                                
                            </ul> 
                        </div>      
	                        	...
	                        	<div class="body_content">
                                    <div class="padd_left">
                                    	<div class="bound">
                                        	...
                                        	<iframe width="100%" height="100%" frameborder="0" src="./Register_Request.ice"  scrolling="auto">
