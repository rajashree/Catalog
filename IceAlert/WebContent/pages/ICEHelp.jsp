    ...
    <div class="body_home01">
                    ...
                    <!-- Navigations -->
                        <div class="navigation">
                            <ul>
                                ...
                                <li class="pipe">|</li>
                                <li class="active_prv"><div class="inactive_link_d"><a href="./Settings.ice" class="hover">Settings</a></div></li>                                
                                <li class="bg_img"><a href="./ICEHelp.ice"><div class="active_link_help">Help</div></a></li>                                
                                <logic:present name="security_profile">
                                	<logic:equal name="security_profile" value="0">
                               			 <li  class="active_next"><html:link href="./SendAlert.ice"><div class="inactive_link_e">
                                			Admin
                            			 </div></html:link></li>
                                	</logic:equal>
                                </logic:present>
	                        	...
	                        	<div class="body_content">
                                    <div class="padd_left">
                                    	<div class="bound">
                                        	...
                                        	<iframe width="100%" height="100%" frameborder="0" src="pages/help_page.html">
       ...
       <div class="footer">
	      ...
	      <div class="footer_links">
	      	...
	      	<input type="hidden" value="help" id="source" name="source"/>
	        <ul>
