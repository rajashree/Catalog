...
<div id="wrapper">
		    <div id="content">
		    <div class="bock-rep">
      		  <h2 class="block-title"><@s.text name="label.timezone"/></h2>
    ...
    <div class="actions">
      ...
      <div class="content">
        <ul>
          <li><a class="active" href="#"><@s.text name="label.general"/></a></li>    
          <li><a   href="<@s.url action='settings'><@s.param name='tab' value='0' /></@s.url>"><@s.text name="label.my.account"/></a></li>
          <li><a   href="<@s.url action='settings'><@s.param name='tab' value='1' /></@s.url>"><@s.text name="label.change.password"/></a></li>          
