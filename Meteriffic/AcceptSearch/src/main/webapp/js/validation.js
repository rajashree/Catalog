...
{	
	...
	$("newConformPassword").style.border="1px solid #d7d7d7";
	...
	if($("newConformPassword").value=="")
	{
		status=1;
		$("newConformPassword").style.border="red solid 1px";
	}
	if(status==0)
	{
		...
		if(($("newPassword").value) != ($("newConformPassword").value)){
			status = 2;
			$("newPassword").style.border="red solid 1px";
			$("newConformPassword").style.border="red solid 1px";
