 ...
 * {@inheritDoc}
 */
public final class SFOrderDataExceptionHandler extends DataExceptionHandlerAdapter {
    ...
    public void onDataWriterException(final DataWriterException e) {
        ...
        if (e.getErrorId().equalsIgnoreCase("SINGLE_ROW")) {
            try {
                String path = SFOrderDataExceptionHandler.getErrorFilePath(e.getTableDefinition().getProperty("relativePath"), e.getTableDefinition().getProperty("startDate"));
            ...
            try {
                ...
                logger.warn("SFOrderDataExceptionHandler onDataWriterException() " + e.getMessage());
            }
