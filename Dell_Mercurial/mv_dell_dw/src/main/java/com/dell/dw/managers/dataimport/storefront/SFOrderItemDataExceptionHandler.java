 ...
 * @version $Revision: 3143 $, $Date:: 2012-06-13 15:28:07#$
 */

/**
 * {@inheritDoc}
 */
public final class SFOrderItemDataExceptionHandler extends DataExceptionHandlerAdapter {
    ...
    public void onDataWriterException(final DataWriterException e) {
        ...
        if (e.getErrorId().equalsIgnoreCase("SINGLE_ROW")) {
            try {
                String path = SFOrderItemDataExceptionHandler.getErrorFilePath(e.getTableDefinition().getProperty("relativePath"), e.getTableDefinition().getProperty("startDate"));
            ...
            try {
                ...
                logger.warn("SFOrderItemDataExceptionHandler onDataWriterException() " + e.getMessage());
            }
