 ...
 * {@inheritDoc}
 */
public final class LinkTrackerDataExceptionHandler extends DataExceptionHandlerAdapter {
    ...
    public void onDataWriterException(final DataWriterException e) {
        ...
        if (e.getErrorId().equalsIgnoreCase("SINGLE_ROW")) {
            try {
                String path = LinkTrackerDataExceptionHandler.getErrorFilePath(e.getTableDefinition().getProperty("relativePath"), e.getTableDefinition().getProperty("startDate"));
            ...
            try {
                ...
                logger.warn("LinkTrackerDataExceptionHandler onDataWriterException() " + e.getMessage());
            }
