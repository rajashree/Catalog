 ...
 * {@inheritDoc}
 */
public final class GAPageViewDataExceptionHandler extends DataExceptionHandlerAdapter {
    ...
    public void onDataWriterException(final DataWriterException e) {
        ...
        if (e.getErrorId().equalsIgnoreCase("SINGLE_ROW")) {
            ...
            try {
                ...
                logger.warn("GAPageViewDataExceptionHandler onDataWriterException() " + e.getMessage());
            }
