 ...
 * @version $Revision: 3782 $, $Date:: 2012-07-03 14:30:29#$
 */

/**
 * {@inheritDoc}
 */
public final class RevenueDataExceptionHandler extends DataExceptionHandlerAdapter {
    ...
    public void onDataWriterException(final DataWriterException e) {
        ...
        if (e.getErrorId().equalsIgnoreCase("SINGLE_ROW")) {
            try {
                String path = RevenueDataExceptionHandler.getErrorFilePath(e.getTableDefinition().getProperty("relativePath"), e.getTableDefinition().getProperty("startDate"));
            ...
            try {
                ...
                logger.warn("RevenueDataExceptionHandler onDataWriterException() " + e.getMessage());
            }
