...
ALTER TABLE t_curation CHECK CONSTRAINT fk_curation_retailerSite_id;

ALTER TABLE t_curation CHECK CONSTRAINT fk_curation_createdBy_id;

ALTER TABLE t_curation CHECK CONSTRAINT fk_curation_modifiedBy_id;

CREATE TABLE t_curation_properties(
	id bigint NOT NULL
...
CREATE TABLE t_curation_source(
	id bigint IDENTITY(1,1) NOT NULL
	,version bigint NOT NULL DEFAULT 0
	,createdDate datetime2(7) NOT NULL
	,description nvarchar(4000) NULL
	...
	,limit int NOT NULL
	,lockedThread nvarchar(4000) NULL
	,modifiedDate datetime2(7) NOT NULL
	,name varchar(255) NOT NULL
...
ALTER TABLE t_curation_source CHECK CONSTRAINT fk_curation_source_createdBy_id;

ALTER TABLE t_curation_source CHECK CONSTRAINT fk_curation_source_modifiedBy_id;
...
CREATE TABLE t_curation_source_properties(
	id bigint NOT NULL
	,name varchar(250) NOT NULL
	,version bigint NOT NULL DEFAULT 0
	,value ntext NULL
...
CREATE TABLE t_curation_source_mapping(
...
ALTER TABLE t_curation_source_mapping CHECK CONSTRAINT fk_curation_source_mapping_curation_id;

ALTER TABLE t_curation_source_mapping CHECK CONSTRAINT fk_curation_source_mapping_curation_source_id;
...
ALTER TABLE t_curation_cache CHECK CONSTRAINT fk_curation_cache_curation_source_id;
...
CREATE TABLE t_curation_cache_properties(
 	id bigint NOT NULL
	,name varchar(250) NOT NULL
	,version bigint NOT NULL DEFAULT 0
	,value ntext NULL
...
CREATE TABLE t_curation_content(
	 id bigint IDENTITY(1,1) NOT NULL
	,version bigint NOT NULL DEFAULT 0
...
ALTER TABLE t_curation_content CHECK CONSTRAINT fk_curation_content_cacheContent_id;

ALTER TABLE t_curation_content CHECK CONSTRAINT fk_curation_content_curation_id;

ALTER TABLE t_curation_content CHECK CONSTRAINT fk_curation_content_document_id;

ALTER TABLE t_curation_content CHECK CONSTRAINT fk_curation_content_createdBy_id;

ALTER TABLE t_curation_content CHECK CONSTRAINT fk_curation_content_modifiedBy_id;
...
CREATE TABLE t_curation_content_properties(
	id bigint NOT NULL
	,name varchar(250) NOT NULL 
	,version bigint NOT NULL DEFAULT 0
	,value ntext NULL
