...
<html>
<head>
    <title>Pixel Tracking - MarketVine</title>
                                            ...
                                            <span class="${item.itemType} title" style="width: 50%">
                                                ...
                                                <c:if test="${ ! empty item.properties.cloned && item.properties.cloned}">
                                                    <a href="<c:url value='/admin/campaign/clone-item.do'/>?id=${item.id}&productID=${item.itemID}&campaignID=${item.campaign.id}"
                                                       title="Edit cloned item"><span
                                                            class="edit_clone status_icon"></span></a>
                                                </c:if>
                    ...
                    <script type="text/javascript">
                        function ajaxFileUpload() {
                            ...
                            if (fileName.length > 0) {
                                 ...
                                 */
                                $.ajaxFileUpload({
                                    url: basePath + 'admin/campaign/uploadCampaignItems.json?pixelTrackerType=marketvine&campaignID='.concat(requestParams.campaignID),
                                    secureuri:false,
                                    dataType: 'json',
                                    ...
                                    error: function (data, status, e) {
                                        ...
                                        if( ajaxResponse != undefined || ajaxResponse != null ) {
                                            ...
                                            } else if (ajaxResponse.indexOf(error4) != -1) {
                                                console.log(error4);
                                                $('#pixel-incorrect-mv').show().fadeOut(7000, "linear");
                                            } else {
