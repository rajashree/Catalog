...
<html>
    <head>
        ...
        <script type="text/javascript" src='<c:url value="/api/v2/rest/lib.do?type=js"/>'></script>
    ...
    <body>
        ...
        examples are
        <ul>
            <li>cs.api.v2.CampaignService.getCampaign(49);</li>
            <li>cs.api.v2.CampaignService.getCampaign(49,function(data){window.console.log("completed", data);});</li>
            <li>cs.api.tests.execute(cs.api.v2.CampaignService.getCampaign,[42], 50, 5);</li>
        </ul>
    </body>
</html>