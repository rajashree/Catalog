...
<div id="page">
    <div id="wrapper">
        ...
        <form name="recommendform" method="post" action="<c:url value="/rest/api/json/v1/recommendproducts"/>">
            <table style="width:100%;">


                <!-- <tr>
                      <td>Product ID::</td>
                      <td><input type="text" name="productID" id="productID" value="1"></td>
               </tr> -->

                <%--<tr>
                    <td>Product Name</td>
                    <td><input type="text" name="productTitle" id="productTitle"
                               value="C9 by Champion Men's Mock-Neck Training Shirt"></td>
                </tr>--%>

                <%-- <tr>
                    <td>Banner Size</td>
                    <td><input type="text" name="bannerSize" id="bannerSize" value="1000"></td>
                </tr>--%>
                ...
                <tr>
                    <td>Advertiser ID</td>
                    <td><input type="text" name="Advertiser_ID" id="Advertiser_ID" value="2"></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>Search Term</td>
                    <td><input type="text" name="SearchTerms" id="SearchTerms" value="product"></td>
                </tr>
                <tr>
                    <td>Resolution</td>
                ...
                <tr>
                    <td>Product ID's</td>
                    <td><input type="text" name="Product_IDs" id="Product_IDs" value="1"><i>(Comma Seprated Values)</i>
                    </td>
                </tr>
                <tr>
                    <td>Product Category</td>
                    <td><input type="text" name="Product_Categories" id="Product_Categories" value="men"></td>
                </tr>
                <tr>
                    <td>Gender::</td>
