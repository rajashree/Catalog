...
public class CampaignBean implements FormBean {
    ...
    private Set<CampaignItemBean> items;
    ...
    public Set<CampaignItemBean> getItems() {
        return items;
    }
    ...
    public void setItems(Set<CampaignItemBean> items) {
        this.items = items;
    }
