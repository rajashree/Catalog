 ...
 * Time: 10:55 AM
 * <p/>
 * An EmailMessage is bean object for email
...
public class EmailMessage implements Serializable {
    ...
    public static final String HEADER_PROPERTY = "coupon.email.header";
    public static final String FOOTER_PROPERTY = "coupon.email.footer";


    //TODO: Need to support attachment if necessary
    ...
    private boolean shouldFreemarkerParse = true;
     ...
     *
     * @param name  the name of the entity who replies should be sent to for this email.
     * @param email the email address of the entity to whom replies are to be sent.
     *
     * @return this
     */
    public EmailMessage setReplyTo(String name, String email) {
        return setReplyTo(new EmailAddress(name, email));
    }

    /**
     * Sets the reply-to header for the email.
     *
     * @param replyTo the email address of the entity to whom replies are to be sent.
     *
     * @return this
     */
    ...
    public boolean shouldFreemarkerParse() {
        return shouldFreemarkerParse;
    }

    public void setShouldFreemarkerParse(boolean shouldFreemarkerParse) {
        this.shouldFreemarkerParse = shouldFreemarkerParse;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (shouldFreemarkerParse != that.shouldFreemarkerParse) {
            return false;
        }
        if (includeHeaderAndFooter != that.includeHeaderAndFooter) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        result = 31 * result + (includeHeaderAndFooter ? 1 : 0);
        result = 31 * result + (shouldFreemarkerParse ? 1 : 0);
    ...
    public String toString() {
        ...
        sb.append(", includeHeaderAndFooter=").append(includeHeaderAndFooter);
        sb.append(", shouldFreemarkerParse=").append(shouldFreemarkerParse);
