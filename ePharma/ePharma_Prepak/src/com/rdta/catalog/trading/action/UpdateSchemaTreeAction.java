...
public class UpdateSchemaTreeAction extends Action
{
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
								 ...
								 throws Exception {
    	log.info("Inside Action UpdateSchemaTreeAction....... ");
		log.info("Inside Action execute of UpdateSchemaTreeAction....");
		try{
		...
		{
	    	ex.printStackTrace();
			log.error("Error in UpdateSchemaTreeAction execute()" + ex);
