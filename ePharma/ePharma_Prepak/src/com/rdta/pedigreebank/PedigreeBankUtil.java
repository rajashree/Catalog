	...
	public  String generateBarChart(String NDC, HttpSession session, PrintWriter pw) {
		...
		try {
				 String category1 = "LotNumber";
				  ...
				  xquery= xquery+"for $s in collection('tig:///ePharma/PedigreeBank')/PedigreeBank/InventoryOnHand[NDC='"+NDC +"']";
...
//		          Create the chart object
   ...
   public  Map getLotNumberandQuantity(String NDC) throws PersistanceException{
		...
		String lotno="";
		String lotq="";
		String xquery ="for $s in collection('tig:///ePharma/PedigreeBank')/PedigreeBank/InventoryOnHand[NDC='"+NDC+"']";
	...
	public  String getNDCforLotNumber(String Lotno) throws Exception{
		...
		try{
     String ndc="";
     String xquery ="for $s in collection('tig:///ePharma/PedigreeBank')/PedigreeBank/InventoryOnHand";
	...
	{ 
		try{ 
		String quantity=""; 
		 String xquery ="for $s in collection('tig:///ePharma/PedigreeBank')/PedigreeBank/InventoryOnHand/LotInfo[LotNumber='"+lotno+"']";
	...
	{
		try{
		String xquery ="tlsp:updatePedigreebankAfterShipment('"+PedigreeEnvelopId+")";
		log.info(xquery);
	...
	public void updatePedigreeBankForReceipt(String ndc,String recId) throws Exception 
	{
		...
		String xquery ="tlsp:UpDatePedigreeBank('"+ndc+"',"+recId+")";
		log.info(xquery);
		queryrunner.executeUpdate(xquery);
		 }catch(PersistanceException e){
