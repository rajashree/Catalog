				...
				<table cellSpacing="1" cellPadding="3" align=center>
					...
					<%
						...
						for(int i=0; i<= size-1; i++)  {
		                    ...
		                    System.out.println("LIST OF  NOT MAPPED"+list);
					...
					%>
						...
						<tr>
							...
							<input type="button"  value="Save Mapping" onClick="return submitform('SAVE',<%=list.size()%>)"></td>
                     ...
                     {
                     %>
                       <tr  bgcolor="white" class="titleBlack">
