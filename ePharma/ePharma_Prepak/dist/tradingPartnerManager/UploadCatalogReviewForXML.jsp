...
function goback() {
    ...
    document.UploadCatalogReview.action = "Catalog.do?&tpGenId=<%=tpGenId%>&tp_company_nm=<%=tp_company_nm%>&pagenm=<%=pagenm%>";
...
<form action="FirstUploadMapValuesToStandardsForXML.do?tpGenId=<%=tpGenId%>&tp_company_nm=<%=tp_company_nm%>&pagenm=<%=pagenm%>&tpList=view&tcList=view"  method="post" >
