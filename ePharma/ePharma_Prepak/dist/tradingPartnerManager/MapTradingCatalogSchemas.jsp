...
<frameset border="1" cols="230,*, 230">
	...
	<frame scrolling=auto name="main" src="./TradingPartnerMappingEdit.do?operationType=<%= request.getParameter("operationType") %>&catalogGenId=<%=request.getParameter("leftCatalogGenId") %>&standardCatalogGenId=<%=request.getParameter("rightCatalogGenId") %>">
