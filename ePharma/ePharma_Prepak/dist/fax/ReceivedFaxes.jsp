...
if( checkSel == false ){
  ...
  return false;
				...
				frm.action = '/ePharma/dist/epedigree/ReceivedFaxes.do';
...
<body>
<form name = "ReceivedFaxes" method="post">
    ...
    <td class="type-whrite" width="10%" align="center">Select</td>
	<td class="type-whrite" width="30%">Fax Name:</td>
	 
	<td class="type-whrite" width="30%">ANI:</td>
	<td class="type-whrite" width="30%">Date Received:</td>
	</tr>
