...
<% if(tp_company_nm.equals(""))	{	//INTERNAL USER  %>
				...
				<td valign="middle" background="../../assets/images/bg_menu.jpg"><table width="800" border="0" cellpadding="0" cellspacing="0" ID="Table2">
						<tr>
							<% if(pagenm.equals("epcadmin")) { %>
								...
								onmouseout="this.style.backgroundColor='';this.style.color=''"><a href="../admin/index.jsp?sessionID=<%=sessionID%>&tp_company_nm=<%=tp_company_nm%>&pagenm=epcadmin" class="menu-link" target="_parent">Admin 
									Console</a></td>
							<% } else { %>
							...
							<% if(pagenm.equals("inv")) { %>
								<td align="center" class="primaryNav_On" onmouseover="this.style.backgroundColor='#FFCC33';this.style.color='#FFFFFF'"
								onmouseout="this.style.backgroundColor='';this.style.color=''"><a href="../invManagement/index.jsp?sessionID=<%=sessionID%>&tp_company_nm=<%=tp_company_nm%>&pagenm=inv" class="menu-link" target="_parent">Inventory 
									Management</a></td>
							<% } else { %>
								<td align="center" class="primaryNav_Off" onmouseover="this.style.backgroundColor='#FFCC33';this.style.color='#FFFFFF'"
									onmouseout="this.style.backgroundColor='';this.style.color=''"><a href="../invManagement/index.jsp?sessionID=<%=sessionID%>&tp_company_nm=<%=tp_company_nm%>&pagenm=inv" class="menu-link" target="_parent">Inventory 
							...
							<% if(pagenm.equals("logist")) { %>
								<td align="center" class="primaryNav_On" onmouseover="this.style.backgroundColor='#FFCC33';this.style.color='#FFFFFF'"
								onmouseout="this.style.backgroundColor='';this.style.color=''"><a href="../logistics/index.jsp?sessionID=<%=sessionID%>&tp_company_nm=<%=tp_company_nm%>&pagenm=logist" class="menu-link" target="_parent">Logistics</a></td>
							<% } else { %>
								<td align="center" class="primaryNav_Off" onmouseover="this.style.backgroundColor='#FFCC33';this.style.color='#FFFFFF'"
								onmouseout="this.style.backgroundColor='';this.style.color=''"><a href="../logistics/index.jsp?sessionID=<%=sessionID%>&tp_company_nm=<%=tp_company_nm%>&pagenm=logist" class="menu-link" target="_parent">Logistics</a></td>
							<% } %>
							...
							<% if(pagenm.equals("pedigree")) { %>
								<td align="center" class="primaryNav_On" onmouseover="this.style.backgroundColor='#FFCC33';this.style.color='#FFFFFF'"
								onmouseout="this.style.backgroundColor='';this.style.color=''"><a href="../epedigree/index.jsp?sessionID=<%=sessionID%>&tp_company_nm=<%=tp_company_nm%>&pagenm=pedigree" class="menu-link menuBlack" target="_parent">ePedigree</a></td>
							<% } else { %>
								<td align="center" class="primaryNav_Off" onmouseover="this.style.backgroundColor='#FFCC33';this.style.color='#FFFFFF'"
								onmouseout="this.style.backgroundColor='';this.style.color=''"><a href="../epedigree/index.jsp?sessionID=<%=sessionID%>&tp_company_nm=<%=tp_company_nm%>&pagenm=pedigree" class="menu-link menuBlack" target="_parent">ePedigree</a></td>
							<% } %>
							...
							<% if(pagenm.equals("recall")) { %>
								<td align="center" class="primaryNav_On" onmouseover="this.style.backgroundColor='#FFCC33';this.style.color='#FFFFFF'"
								onmouseout="this.style.backgroundColor='';this.style.color=''"><a href="../prodRecall/index.jsp?sessionID=<%=sessionID%>&tp_company_nm=<%=tp_company_nm%>&pagenm=recall" class="menu-link" target="_parent">Product 
									Recall</a></td>
							<% } else { %>
								<td align="center" class="primaryNav_Off" onmouseover="this.style.backgroundColor='#FFCC33';this.style.color='#FFFFFF'"
								onmouseout="this.style.backgroundColor='';this.style.color=''"><a href="../prodRecall/index.jsp?sessionID=<%=sessionID%>&tp_company_nm=<%=tp_company_nm%>&pagenm=recall" class="menu-link" target="_parent">Product 
							...
							<% if(pagenm.equals("track")) { %>
								<td align="center" class="primaryNav_On" onmouseover="this.style.backgroundColor='#FFCC33';this.style.color='#FFFFFF'"
									onmouseout="this.style.backgroundColor='';this.style.color=''"><a href="../trackTrace/index.jsp?sessionID=<%=sessionID%>&tp_company_nm=<%=tp_company_nm%>&pagenm=track" class="menu-link" target=_top>Track 
									and Trace</a></td>
							<% } else { %>
								<td align="center" class="primaryNav_Off" onmouseover="this.style.backgroundColor='#FFCC33';this.style.color='#FFFFFF'"
									onmouseout="this.style.backgroundColor='';this.style.color=''"><a href="../trackTrace/index.jsp?sessionID=<%=sessionID%>&tp_company_nm=<%=tp_company_nm%>&pagenm=track" class="menu-link" target=_top>Track 
							...
							<% if(pagenm.equals("busintel")) { %>
								<td align="center" class="primaryNav_On" onmouseover="this.style.backgroundColor='#FFCC33';this.style.color='#FFFFFF'"
								onmouseout="this.style.backgroundColor='';this.style.color=''"><a href="../bizIntel/index.jsp?sessionID=<%=sessionID%>&tp_company_nm=<%=tp_company_nm%>&pagenm=busintel" class="menu-link" target="_parent">Business 
									Intelligence</a></td>
							<% } else { %>
								<td align="center" class="primaryNav_Off" onmouseover="this.style.backgroundColor='#FFCC33';this.style.color='#FFFFFF'"
								onmouseout="this.style.backgroundColor='';this.style.color=''"><a href="../bizIntel/index.jsp?sessionID=<%=sessionID%>&tp_company_nm=<%=tp_company_nm%>&pagenm=busintel" class="menu-link" target="_parent">Business 
	...
	<div id="menu1" style="Z-INDEX: 102">
		<table width="100%" height="25" border="0" cellpadding="0" cellspacing="0" ID="Table3">
			<tr>
				<td valign="bottom" background="../../assets/images/bg_menu.jpg"><table width="750" border="0" cellpadding="0" cellspacing="0" ID="Table4">
						<tr>
							<td align="center" class="primaryNav_Off" onmouseover="this.style.backgroundColor='#FFCC33';this.style.color='#FFFFFF'"
								onmouseout="this.style.backgroundColor='';this.style.color=''"><a href="/ePharma/TradingPartnerList.do" class="menu-link" target="_parent">Trading 
									Partner Manager</a></td>
							<td><img src="../../assets/images/menu_bg1.jpg" width="3" height="23"></td>
							<% if(pagenm.equals("diversion")) { %>
								<td align="center" class="primaryNav_On" onmouseover="this.style.backgroundColor='#FFCC33';this.style.color='#FFFFFF'"
								onmouseout="this.style.backgroundColor='';this.style.color=''"><a href="../diversion/index.jsp?sessionID=<%=sessionID%>&tp_company_nm=<%=tp_company_nm%>&pagenm=diversion" class="menu-link" target="_parent">Diversion</a></td>
							<% } else { %>
								<td align="center" class="primaryNav_Off" onmouseover="this.style.backgroundColor='#FFCC33';this.style.color='#FFFFFF'"
								onmouseout="this.style.backgroundColor='';this.style.color=''"><a href="../diversion/index.jsp?sessionID=<%=sessionID%>&tp_company_nm=<%=tp_company_nm%>&pagenm=diversion" class="menu-link" target="_parent">Diversion</a></td>
							<% } %>
							<td><img src="../../assets/images/menu_bg1.jpg" width="3" height="23"></td>
							<td align="center" class="primaryNav_Off" onmouseover="this.style.backgroundColor='#FFCC33';this.style.color='#FFFFFF'"
								onmouseout="this.style.backgroundColor='';this.style.color=''"><a href="../catalog/index.html" class="menu-link" target="_parent">Catalog</a></td>
							<td><img src="../../assets/images/menu_bg1.jpg" width="3" height="23"></td>
							<% if(pagenm.equals("authentic")) { %>
								<td align="center" class="primaryNav_On" onmouseover="this.style.backgroundColor='#FFCC33';this.style.color='#FFFFFF'"
								onmouseout="this.style.backgroundColor='';this.style.color=''"><a href="../authentication/index.jsp?sessionID=<%=sessionID%>&tp_company_nm=<%=tp_company_nm%>&pagenm=authentic" class="menu-link" target="_parent">Authentication</a></td>
							<% } else { %>
								<td align="center" class="primaryNav_Off" onmouseover="this.style.backgroundColor='#FFCC33';this.style.color='#FFFFFF'"
								onmouseout="this.style.backgroundColor='';this.style.color=''"><a href="../authentication/index.jsp?sessionID=<%=sessionID%>&tp_company_nm=<%=tp_company_nm%>&pagenm=authentic" class="menu-link" target="_parent">Authentication</a></td>
							<% } %>
							...
							<% if(pagenm.equals("integrity")) { %>
								<td align="center" class="primaryNav_On" onmouseover="this.style.backgroundColor='#FFCC33';this.style.color='#FFFFFF'"
								onmouseout="this.style.backgroundColor='';this.style.color=''"><a href="../productIntegrity/index.jsp?sessionID=<%=sessionID%>&tp_company_nm=<%=tp_company_nm%>&pagenm=integrity" class="menu-link" target="_parent">Product 
									Integrity</a></td>
							<% } else { %>
								<td align="center" class="primaryNav_Off" onmouseover="this.style.backgroundColor='#FFCC33';this.style.color='#FFFFFF'"
									onmouseout="this.style.backgroundColor='';this.style.color=''"><a href="../productIntegrity/index.jsp?sessionID=<%=sessionID%>&tp_company_nm=<%=tp_company_nm%>&pagenm=integrity" class="menu-link" target="_parent">Product 
							...
							<% if(pagenm.equals("reports")) { %>
								<td align="center" class="primaryNav_On" onmouseover="this.style.backgroundColor='#FFCC33';this.style.color='#FFFFFF'"
								onmouseout="this.style.backgroundColor='';this.style.color=''"><a href="../reports/AdvancedReports.do?sessionID=<%=sessionID%>&tp_company_nm=<%=tp_company_nm%>&pagenm=reports" class="menu-link" target="_parent">Reports</a></td>
							<% } else { %>
								<td align="center" class="primaryNav_Off" onmouseover="this.style.backgroundColor='#FFCC33';this.style.color='#FFFFFF'"
								onmouseout="this.style.backgroundColor='';this.style.color=''"><a href="../reports/AdvancedReports.do?sessionID=<%=sessionID%>&tp_company_nm=<%=tp_company_nm%>&pagenm=reports" class="menu-link" target="_parent">Reports</a></td>
							<% } %>
	...
	if(!pagenm.equals("reports")) { %>
		...
		<div id="leftgray" style="Z-INDEX: 104">
			<table width="170" height="100%" border="0" cellpadding="0" cellspacing="0" ID="Table5">
				<tr>
					<td width="170" colspan="2" class="td-leftred">ePharma</td>			
				</tr>
				<tr>
					<td width="10" valign="top" bgcolor="#dcdcdc"></td>
					<td valign="top" class="td-left"><br>
						<a href="../epedigree/ePedigree_ReceivingManager.jsp?sessionID=<%=sessionID%>&pagenm=pedigree&tp_company_nm=<%=tp_company_nm%>" class="typeblue1-link-sub">Receiving 
							Manager<br>
						</a>
						<br>
						<br>
		...
		<table width="170" height="100%" border="0" cellpadding="0" cellspacing="0" ID="Table5">
			...
			<tr>
				...
				<td valign="top" class="td-left"><br>
					...
					<br>
					<a href="../epedigree/ePedigree_ShippingManager.html" class="typeblue1-link-sub">Shipping 
						Manager<br>
					</a>
					<br>
					<a href="../epedigree/ePedigree_Commissioning_Repackaging.html" class="typeblue1-link-sub">Packaging<br>
					</a><a href="../epedigree/ePedigree_Commissioning_Repackaging.html" class="typeblue1-link-sub-sub">
						&nbsp;&nbsp;&nbsp;Commissioning Station<br>
					</a><a href="../epedigree/ePedigree_Commissioning_Repackaging.html" class="typeblue1-link-sub-sub">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Item</a><br>
					<a href="../epedigree/ePedigree_Commissioning_Station_Package.html" class="typeblue1-link-sub-sub">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Package</a><br>
					<a href="../epedigree/ePedigree_Commissioning_ProductionRun.html" class="typeblue1-link-sub-sub">
						&nbsp;&nbsp;&nbsp;Production Run</a><br>
					<a href="../epedigree/ePedigree_Commissioning_View.html" class="typeblue1-link-sub-sub">&nbsp;&nbsp;&nbsp;View 
						Commissioned Items</a><br>
					<a href="../epedigree/ePedigree_Commissioning_AggregationStation.html" class="typeblue1-link-sub-sub">
					...
					<a href="../epedigree/ePedigree_APNManager_Search.html" class="typeblue1-link-sub-sub">&nbsp;&nbsp;&nbsp;Search 
						APNs</a><br>
					<a href="../epedigree/ePedigree_Orders_Search.html" class="typeblue1-link-sub-sub">&nbsp;&nbsp;&nbsp;Search 
						Orders</a><br>
					<a href="../epedigree/ePedigree_Invoices_Search.html" class="typeblue1-link-sub-sub">&nbsp;&nbsp;&nbsp;Search 
						Invoices</a><br>
					<a href="../epedigree/ePedigree_POS_Search.html" class="typeblue1-link-sub-sub">&nbsp;&nbsp;&nbsp;Search 
						POs</a><br>
					<a href="../epedigree/ePedigree_ASN_Search.html" class="typeblue1-link-sub-sub">&nbsp;&nbsp;&nbsp;Search 
						ASNs</a><br>
					<br>
					<a href="../epedigree/ePedigree_Reports.html" class="typeblue1-link-sub">Reporting</a><br>
					<a href="../epedigree/ePedigree_Reports.html" class="typeblue1-link-sub-sub">&nbsp;&nbsp;&nbsp;ePedigree</a><br>
					...
					<a href="../epedigree/ePedigree_Reports_Repackaging.html" class="typeblue1-link-sub-sub">&nbsp;&nbsp;&nbsp;Repackaging</a><br>
					<br>
					<a href="../epedigree/ePedigree_Workflow.html" class="typeblue1-link-sub">Event Workflow</a><br>
					<a href="../epedigree/ePedigree_CreateWorkflow.html" class="typeblue1-link-sub-sub">&nbsp;&nbsp;&nbsp;Create</a><br>
					<a href="../epedigree/ePedigree_EditWorkflow.html" class="typeblue1-link-sub-sub">&nbsp;&nbsp;&nbsp;View/Edit</a>
				</td>
			</tr>
			<tr valign="bottom">
				<td height="80" colspan="2" class="td-left"><img src="../../assets/images/logo_poweredby.gif" width="150" height="37"></td>
				...
				<td valign="middle" background="../../assets/images/bg_menu.jpg"><table width="800" border="0" cellpadding="0" cellspacing="0" ID="Table2">
						<tr>	
							<% if(pagenm.equals("admin")) { %>
								<td align="center" class="primaryNav_On" onmouseover="this.style.backgroundColor='#FFCC33';this.style.color='#FFFFFF'"
									onmouseout="this.style.backgroundColor='';this.style.color=''"><a href="../admin/extindex.jsp?sessionID=<%=sessionID%>&tp_company_nm=<%=tp_company_nm%>&pagenm=admin" class="menu-link" target=_top>Admin 
										Console</a></td>
							<% } else { %>
								<td align="center" class="primaryNav_Off" onmouseover="this.style.backgroundColor='#FFCC33';this.style.color='#FFFFFF'"
										onmouseout="this.style.backgroundColor='';this.style.color=''"><a href="../admin/extindex.jsp?sessionID=<%=sessionID%>&tp_company_nm=<%=tp_company_nm%>&pagenm=admin" class="menu-link" target=_top>Admin 
							...
							<% if(pagenm.equals("pedigree")) { %>
								<td align="center" class="primaryNav_On" onmouseover="this.style.backgroundColor='#FFCC33';this.style.color='#FFFFFF'"
									onmouseout="this.style.backgroundColor='';this.style.color=''"><a href="../epedigree/index.jsp?sessionID=<%=sessionID%>&pagenm=pedigree&tp_company_nm=<%=tp_company_nm%>" class="menu-link menuBlack" target=_top>ePedigree</a></td>
							<% } else { %>
								<td align="center" class="primaryNav_Off" onmouseover="this.style.backgroundColor='#FFCC33';this.style.color='#FFFFFF'"
								onmouseout="this.style.backgroundColor='';this.style.color=''"><a href="../epedigree/index.jsp?sessionID=<%=sessionID%>&pagenm=pedigree&tp_company_nm=<%=tp_company_nm%>" class="menu-link menuBlack" target=_top>ePedigree</a></td>
							<% } %>
							...
							<% if(pagenm.equals("recall")) { %>
								<td align="center" class="primaryNav_On" onmouseover="this.style.backgroundColor='#FFCC33';this.style.color='#FFFFFF'"
								onmouseout="this.style.backgroundColor='';this.style.color=''"><a href="../prodRecall/index.jsp?sessionID=<%=sessionID%>&tp_company_nm=<%=tp_company_nm%>&pagenm=recall" class="menu-link" target=_top>Product 
									Recall</a></td>
							<% } else { %>
								<td align="center" class="primaryNav_Off" onmouseover="this.style.backgroundColor='#FFCC33';this.style.color='#FFFFFF'"
									onmouseout="this.style.backgroundColor='';this.style.color=''"><a href="../prodRecall/index.jsp?sessionID=<%=sessionID%>&tp_company_nm=<%=tp_company_nm%>&pagenm=recall" class="menu-link" target=_top>Product 
							...
							<% if(pagenm.equals("authentic")) { %>
									<td align="center" class="primaryNav_On" onmouseover="this.style.backgroundColor='#FFCC33';this.style.color='#FFFFFF'"
									onmouseout="this.style.backgroundColor='';this.style.color=''"><a href="../authentication/index.jsp?sessionID=<%=sessionID%>&tp_company_nm=<%=tp_company_nm%>&pagenm=authentic" class="menu-link" target=_top>Authentication</a></td>
							<% } else { %>
									<td align="center" class="primaryNav_Off" onmouseover="this.style.backgroundColor='#FFCC33';this.style.color='#FFFFFF'"
									onmouseout="this.style.backgroundColor='';this.style.color=''"><a href="../authentication/index.jsp?sessionID=<%=sessionID%>&tp_company_nm=<%=tp_company_nm%>&pagenm=authentic" class="menu-link" target=_top>Authentication</a></td>
							<% } %>
							...
							<% if(pagenm.equals("reports")) { %>
									<td align="center" class="primaryNav_On" onmouseover="this.style.backgroundColor='#FFCC33';this.style.color='#FFFFFF'"
									onmouseout="this.style.backgroundColor='';this.style.color=''"><a href="../reports/index.jsp?sessionID=<%=sessionID%>&tp_company_nm=<%=tp_company_nm%>&pagenm=reports" class="menu-link" target=_top>Reports</a></td>
							<% } else { %>
									<td align="center" class="primaryNav_Off" onmouseover="this.style.backgroundColor='#FFCC33';this.style.color='#FFFFFF'"
									onmouseout="this.style.backgroundColor='';this.style.color=''"><a href="../reports/index.jsp?sessionID=<%=sessionID%>&tp_company_nm=<%=tp_company_nm%>&pagenm=reports" class="menu-link" target=_top>Reports</a></td>
							<% } %>
	...
	<div id="leftgray2" style="Z-INDEX: 104">
		<table width="170" height="100%" border="0" cellpadding="0" cellspacing="0" ID="Table5">
			...
			<tr>
				<td width="10" valign="top" bgcolor="#dcdcdc"></td>
				<td valign="top" class="td-left"><br>
					<a href="ePedigree_ReceivingManager.jsp?sessionID=<%=sessionID%>&pagenm=pedigree&tp_company_nm=<%=tp_company_nm%>" class="typeblue1-link-sub">Receiving 
						Manager<br>
					</a>
					<br>
					<br>
					<a href="#" class="typeblue1-link-sub">Find</a><br>
					<a href="ePedigree_Manager_Search.html" class="typeblue1-link-sub-sub">&nbsp;&nbsp;&nbsp;Search 
						Orders</a><br>
					<a href="ePedigree_APNManager_Search.html" class="typeblue1-link-sub-sub">&nbsp;&nbsp;&nbsp;Search 
						ePedigre</a>
					<br>
					<br>
					<a href="ePedigree_Reports.html" class="typeblue1-link-sub">Reporting</a><br>
					...
					<a href="ePedigree_Reports_Repackaging.html" class="typeblue1-link-sub-sub">&nbsp;&nbsp;&nbsp;Repackaging</a><br>
