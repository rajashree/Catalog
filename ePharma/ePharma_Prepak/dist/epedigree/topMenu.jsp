...
%>
				...
				<td valign="middle" background="<%=servPath%>/assets/images/bg_menu.jpg"><table width="800" border="0" cellpadding="0" cellspacing="0" ID="Table2">
						<tr>
							...
							<% if(pagenm.equals("TPManager")) { %>
								<td align="center" class="primaryNav_On" onmouseover="this.style.backgroundColor='#FFCC33';this.style.color='#FFFFFF'"
								onmouseout="this.style.backgroundColor='';this.style.color=''"><a href="/ePharma/TradingPartnerList.do?tp_company_nm=<%=tp_company_nm%>&pagenm=TPManager" class="menu-link" target="_parent">Trading Partner Manager</a></td>
							<% } else { %>
								<td align="center" class="primaryNav_Off" onmouseover="this.style.backgroundColor='#FFCC33';this.style.color='#FFFFFF'"
								onmouseout="this.style.backgroundColor='';this.style.color=''"><a href="/ePharma/TradingPartnerList.do?tp_company_nm=<%=tp_company_nm%>&pagenm=TPManager" class="menu-link" target="_parent">Trading Partner Manager</a></td>
							<% } %>
	...
	<% if(pagenm.equals("TPManager")) { %>
		...
		<div id="leftgray2" style="Z-INDEX: 104"> 
		  <table width="170" height="100%" border="0" cellpadding="0" cellspacing="0" ID="Table5">
		    <tr> 
		      <td width="170" colspan="2" class="td-leftred">Trading Partner Manager</td>
		    </tr>
		    <tr> 
		      <td width="10" valign="top" bgcolor="#DCDCDC"></td>
		      <td valign="top" class="td-left"><br>
		        <a href="TradingPartnerList.do?tp_company_nm=<%=tp_company_nm%>&pagenm=TPManager&linkName=tpmanager" class=<%=(linkName.equals("tpmanager"))?"typered4-link":"typeblue3-link"%>><strong>Trading Partner Manager</strong></a><br> 
...
String  tpName1=request.getParameter("tpName");
		 ...
		 &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; 	 <a href="OpenCatalogSchemaDef.do?fromModule=TP&catalogGenId=<%= genId%>&tp_company_nm=<%=tp_company_nm%>&pagenm=<%=pagenm%>&tpList=view&tcList=view&linkName=catSchemaDef" class=<%=(linkName.equals("catSchemaDef"))?"typered4-link":"typeblue3-link"%> onClick="return CatalogAccessPrivilage()">
			 ...
			 %>
		  		...
		  		<% } %>
			<a href="TradingPartnerNew.do?tp_company_nm=<%=tp_company_nm%>&pagenm=TPManager&linkName=createTP" class=<%=(linkName.equals("createTP"))?"typered4-link":"typeblue3-link"%> >Create New Trading Partner</a><br>
		      </td>
		    </tr>
		    <tr valign="bottom"> 
		      <td height="80" colspan="2" class="td-left"><img src="./assets/images/logo_poweredby.gif" width="150" height="37"></td>
		...
		<table width="170" height="100%" border="0" cellpadding="0" cellspacing="0" ID="Table5">
			...
			<tr>
				...
				<td valign="top" class="td-left"><br>
					...
					<a href="../epedigree/PedigreeSearch.do?pagenm=pedigree&tp_company_nm=<%=tp_company_nm%>&accesslevel=apnsearch&linkName=apnsear" class=<%=(linkName.equals("apnsear"))?"typered4-link":"typeblue3-link"%>>Search Pedigrees</a><br>
