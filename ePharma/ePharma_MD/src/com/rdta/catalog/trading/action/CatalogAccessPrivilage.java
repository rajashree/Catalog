...
public class CatalogAccessPrivilage extends Action{
	
	private static Log log = LogFactory.getLog(CatalogAccessPrivilage.class);
	private static final QueryRunner queryrunner = QueryRunnerFactory.getInstance().getDefaultQueryRunner();
	
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)throws Exception
	{
	    log.info("Inside CatalogAccessPrivilage...");
		...
		return mapping.findForward("success");
			...
			log.info("No ACCESS");return mapping.findForward("failure");
		}
	}
