...
public class CertifyPedigreeDetailAction extends Action {
	
	private static Log log=LogFactory.getLog(CertifyPedigreeDetailAction.class);
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws PersistanceException 
	{
		...
		String username = temp1.substring(m+1,temp1.length());
			...
			List accessList1 = queryRunner.returnExecuteQueryStrings("tlsp:validateAccess_MD('"+sessionID+"','8.0','Insert')");
		...
		//EAG-TimeStamp
		String buff = "tlsp:CreateEAG-TimeStampType_MD()";
		...
		String insertQuery = "tig:insert-document( 'tig:///ePharma_MD/CertifyPedigree/', "+CertifyPedigree+")";
