...
public class SmtpClientUtil {
	
	private static  String SMTP_AUTH_USER; 
	private static  String SMTP_AUTH_PWD;
	private static  String SMTP_SERVER;
	private static Log log=LogFactory.getLog(SmtpClientUtil.class);
	 
	public SmtpClientUtil(){
		
	}

    public static String sendEmail(String emailFrom, String emailTo, String smtpServer, String emailSubject, String emailMessage,String test) {
    ...
    public static String sendEmailAttachement(
            String emailFrom, String emailTo, 
            String smtpServer,  String emailSubject, 
            String emailMessage, String attachement, String uName, String pwd)  {
...
//          Part two is attachment
            ...
            File file = new File("C:\\temp\\APN.xml");       
