...
public class DisplayRuleSetAction extends Action
{
	private static Log log = LogFactory.getLog(DisplayRuleSetAction.class);
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		if(operation != null)
		{
			if(operation.trim().equalsIgnoreCase(OperationType.FIND))
			{
				...
				String s = RulesXMLStructure.getRuleSetDisplay(cc);
				request.setAttribute("ruleSetDisplay",s );
