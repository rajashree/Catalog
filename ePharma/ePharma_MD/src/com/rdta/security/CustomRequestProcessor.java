...
public class CustomRequestProcessor extends RequestProcessor {
    ...
    protected boolean processPreprocess (
        ...
        if(session == null || sessionID == null){
        	...
        	String str = "";
        	try {
				 str= queryRunner.returnExecuteQueryStringsAsString("tlsp:CheckSessionExisting_MD('"+sessionID+"')");
    ...
    private void updateSession(String sessionID) {
        ...
        try {
            String query3="tlsp:updateLastUseInLoggin_MD('"+sessionID+"','"+screenEnteredDT+"')";
