    ...
    <tr> 
      ...
      <td><table border="0" cellspacing="0" cellpadding="0" width="100%">
		...
		<table width="100%" id="Table1" cellSpacing="1" cellPadding="1" align="left" border="0" bgcolor="white">
			<tr bgcolor="white">
				<td class="td-typeblack" colspan="3">Case Returns</td>
			</tr>
			<tr>
				<td align="left">
					<!-- Dashboard Start -->
				...
				<tr>
					...
					<TD width=20% nowrap>Scan Case Barcode</TD>
					<TD class=tableData valign=baseline><INPUT TYPE=TEXT VALUE='' NAME='eDate' SIZE=15></td>
				</tr>
				<!-- <tr>
					<TD class=tableLabel valign=baseline nowrap>Enter NDC</td>
					<TD class=tableData valign=baseline><INPUT TYPE=TEXT VALUE='1234567890' NAME='eDate' SIZE=15></td>

				</tr> -->
				<!-- <Tr>
					<Td class="tableLabel" width="20%" nowrap>RMA</Td>
					<Td class="tableData"><INPUT TYPE=TEXT VALUE='1234567890' NAME='eDate' SIZE=15></Td>
				</Tr> -->
				<!-- 
				 
				<Tr>
				        <Td class="tableLabel">Product GTIN:&nbsp;[R]&nbsp;</Td>
					<Td class="tableData"><input type="text" size="20" maxlength="30" name="PRODUCT" value=""></Td>
				</Tr> -->
				<Tr>
					<Td colspan="2"><input name="Submit3" type="submit" class="fButton_large" id="Submit2" onClick="MM_goToURL('parent','returns_EPC_2.jsp?sessionID=<%=sessionID%>&tp_company_nm=<%=tp_company_nm%>&pagenm=returns');return document.MM_returnValue" value="Create RMA"></Td>
				</Tr>
				</table></td>
					</tr>	
