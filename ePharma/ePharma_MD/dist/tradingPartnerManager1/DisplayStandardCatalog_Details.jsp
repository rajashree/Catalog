    ...
    <td><table border="0" cellspacing="0" cellpadding="0" width="100%">
        ...
        <tr> 
          <td> 
			...
			bgcolor="white">
                <tr bgcolor="white"> 
                  <td class="td-typeblack">List of Standard Catalogs</td>
				  <td><a href="CatalogNew.do" class="typered-bold-link">Create New Standard Catalog</a></td>
                </tr>
                <tr> 
                  <td align="left">
					<TABLE cellSpacing="1" cellPadding="3" border="0" width="100%">				
					<tr class="tableRow_Header">
					<td class="type-whrite">Catalog Name</td>					
				</tr>
