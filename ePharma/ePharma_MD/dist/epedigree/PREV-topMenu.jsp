				...
				<td valign="bottom" background="../../assets/images/bg_menu.jpg"><table width="750" border="0" cellpadding="0" cellspacing="0" ID="Table4">
						<tr>
							...
							<% if(pagenm.equals("reports")) { %>
								<td align="center" class="primaryNav_On" onmouseover="this.style.backgroundColor='#FFCC33';this.style.color='#FFFFFF'"
								onmouseout="this.style.backgroundColor='';this.style.color=''"><a href="../reports/index.jsp?sessionID=<%=sessionID%>&tp_company_nm=<%=tp_company_nm%>&pagenm=reports" class="menu-link" target="_parent">Reports</a></td>
							<% } else { %>
								<td align="center" class="primaryNav_Off" onmouseover="this.style.backgroundColor='#FFCC33';this.style.color='#FFFFFF'"
								onmouseout="this.style.backgroundColor='';this.style.color=''"><a href="../reports/index.jsp?sessionID=<%=sessionID%>&tp_company_nm=<%=tp_company_nm%>&pagenm=reports" class="menu-link" target="_parent">Reports</a></td>
							<% } %>
	...
	<div id="leftgray" style="Z-INDEX: 104">
		<table width="170" height="100%" border="0" cellpadding="0" cellspacing="0" ID="Table5">
			...
			<tr>
				<td width="10" valign="top" bgcolor="#dcdcdc"></td>
				<td valign="top" class="td-left"><br>
					<a href="ePedigree_ReceivingManager.jsp" class="typeblue1-link-sub">Receiving 
						Manager<br>
					</a>
					<br>
					<a href="ePedigree_ShippingManager.html" class="typeblue1-link-sub">Shipping 
						Manager<br>
					</a>
					<br>
					<a href="ePedigree_Commissioning_Repackaging.html" class="typeblue1-link-sub">Packaging<br>
					</a><a href="ePedigree_Commissioning_Repackaging.html" class="typeblue1-link-sub-sub">
						&nbsp;&nbsp;&nbsp;Commissioning Station<br>
					</a><a href="ePedigree_Commissioning_Repackaging.html" class="typeblue1-link-sub-sub">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Item</a><br>
					<a href="ePedigree_Commissioning_Station_Package.html" class="typeblue1-link-sub-sub">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Package</a><br>
					<a href="ePedigree_Commissioning_ProductionRun.html" class="typeblue1-link-sub-sub">
						&nbsp;&nbsp;&nbsp;Production Run</a><br>
					<a href="ePedigree_Commissioning_View.html" class="typeblue1-link-sub-sub">&nbsp;&nbsp;&nbsp;View 
						Commissioned Items</a><br>
					<a href="ePedigree_Commissioning_AggregationStation.html" class="typeblue1-link-sub-sub">
					...
					<a href="ePedigree_Reports_Repackaging.html" class="typeblue1-link-sub-sub">&nbsp;&nbsp;&nbsp;Repackaging</a><br>
					<br>
					<a href="ePedigree_Workflow.html" class="typeblue1-link-sub">Event Workflow</a><br>
					<a href="ePedigree_CreateWorkflow.html" class="typeblue1-link-sub-sub">&nbsp;&nbsp;&nbsp;Create</a><br>
					<a href="ePedigree_EditWorkflow.html" class="typeblue1-link-sub-sub">&nbsp;&nbsp;&nbsp;View/Edit</a>
				</td>
			</tr>
			<tr valign="bottom">
				<td height="80" colspan="2" class="td-left"><img src="../../assets/images/logo_poweredby.gif" width="150" height="37"></td>
