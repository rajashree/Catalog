...
System.out.println("********Inside Already Certified*******");
%>
			...
			<tr>
				...
				<td>
					...
					<table width="100%" id="Table2" cellSpacing="0" cellPadding="0" align="left" border="0"
						bgcolor="#C0C0C0">
						<tr bgcolor="#C0C0C0">
							<td class="td-typeblack"><center><STRONG>The Pedigrees inside Envelope are already Authenticated ...!</STRONG></center></td>
						</tr>
