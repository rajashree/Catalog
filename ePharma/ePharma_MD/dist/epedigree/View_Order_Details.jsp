...
System.out.println("order no in view orderdetails.jsp :"+tranNumber);
String HTMLROW = "";
String TRANSROW = "";
String SHIPROW1 = "";
String SHIPROW2 = "";
...
xQuery = xQuery + "<td class='td-menu' width='30%'>{data($b/$b/BuyerParty/BuyerContact/Name)}</td> ";
xQuery = xQuery + "</tr> ";
xmlResults = ReadTL(statement, xQuery);
if(xmlResults != null) {
...
<body>
	...
	<BR>
<form action="<%=servPath%>/dist/epedigree/OrderSearch.do?pagenm=pedigree&tp_company_nm=<%=tp_company_nm%>" method = "post">
...
<!--			<tr>
    ...
    </tr><tr><td><center><html:button property="button1" value="Go Back" onclick="javascript:history.back()" /></center></td></tr>
  </table>
