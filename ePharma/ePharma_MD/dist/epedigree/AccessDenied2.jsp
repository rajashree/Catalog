...
<html>
	...
	<body>
		<%@include file='topMenu.jsp'%>		
			...
			<form action="ShippingManagerSearch.do?pagenm=pedigree&tp_company_nm=" method="post">
			...
			<table border="0" cellpadding="0" cellspacing="1" width="100%" ID="Table9">
				...
				<td>
					...
					<table width="100%" id="Table2" cellSpacing="1" cellPadding="1" align="left" border="0"
						...
						<tr bgcolor="white">
							<td class="td-typeblack" align="center"><input type=button  value="Go Back" onclick="javascript:history.back()" ></td>
						</tr>
						<br><br>
						<Td colspan="2"><br>
						<table border="0" cellpadding="0" cellspacing="1" width="100%" ID="Table9">
