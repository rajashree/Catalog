...
<FORM name= "CancelForm" ACTION="Catalog.do?tpGenId=<%=tpGenId%>&tp_company_nm=<%=tp_company_nm%>&pagenm=<%=pagenm%>&tpList=view&tcList=view"  method="post" >
...
<FORM name= "UploadMapValuesToStandard" ACTION="UploadMapValuesToStandardsForXML.do?tpGenId=<%=tpGenId%>&tp_company_nm=<%=tp_company_nm%>&pagenm=<%=pagenm%>&tpList=view&tcList=view"  method="post" >
