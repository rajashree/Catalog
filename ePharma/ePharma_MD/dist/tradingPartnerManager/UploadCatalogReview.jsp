...
function goback() {
    ...
    document.UploadCatalogReview.action = "Catalog.do?&tp_company_nm=<%=tp_company_nm%>&pagenm=<%=pagenm%>&tpList=view&tcList=view&catSchema=view";
...
<%
  ...
  System.out.println("   size  "  + notMatchSourceColList.size());

  System.out.println("  reconcilableList  "  + reconcilableList.size());
...
<form action="FirstUploadMapValuesToStandards.do?&tp_company_nm=<%=tp_company_nm%>&pagenm=<%=pagenm%>&tpList=view&tcList=view&catSchema=view"  method="post" >
