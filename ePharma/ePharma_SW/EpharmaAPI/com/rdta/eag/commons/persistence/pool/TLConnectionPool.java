package com.rdta.eag.commons.persistence.pool;
...
public class  TLConnectionPool
{
	...
	public Connection borrowConnection() throws Exception {
	    ...
	    // Just for testing, uncomment the above line in production.
	    TLConnectionFactory fact = new TLConnectionFactory();
	    return (Connection) fact.makeObject();
	}
