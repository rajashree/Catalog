...
public class SessionListener implements HttpSessionListener{
	...
	public void sessionDestroyed(HttpSessionEvent se){
		...
		try {
			log.info("Query:tlsp:deleteInvlidSessionID('"+session.getAttribute("sessionID")+"')");
			queryRunner.executeUpdate("tlsp:deleteInvlidSessionID('"+session.getAttribute("sessionID")+"')");
