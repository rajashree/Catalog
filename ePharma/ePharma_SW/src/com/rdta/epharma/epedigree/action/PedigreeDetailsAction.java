	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try{
			...
			if(name != null && name.equalsIgnoreCase("pedDetails") && pedType.equalsIgnoreCase("Shipped-Received")){
				pedt="tlsp:ShippedORReceivedPedigreeDetailsRP('ReceivedPedigree','"+pedigreeid+"','"+pid+"')";
			}else if(pedType != null && pedType.equalsIgnoreCase("Shipped-Initial")) 
				pedt="tlsp:InitialPedigreeDetailsRP('ReceivedPedigree','"+pedigreeid+"','"+envid+"')"; 
			else
				pedt="tlsp:ShippedPedigreedetails('"+pedigreeid+"')";
			...
			String statusOfPedigrees ="tlsp:getAuthPedStatus('"+ pedigreeid+"')";
