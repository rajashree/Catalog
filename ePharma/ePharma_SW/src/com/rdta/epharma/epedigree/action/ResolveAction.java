	 ...
	 public ActionForward execute(ActionMapping mapping, ActionForm form,
		 ...
		 logger.info("message id:"+MessageID);
			 ...
			 if(buttonname.equalsIgnoreCase("Change Status")){
				 ...
				 List accessList = queryRunner.returnExecuteQueryStrings("tlsp:validateAccess('"+sessionID+"','2.20','Update')");
				...
				for(int i=0; i<MessageID.length;i++){		
				 ...
				 String query = "replace doc( for $i in collection('tig:///ePharma/Alerts') ";
			 ...
			 if(buttonname.equalsIgnoreCase("Resolve")){
				 List accessList = queryRunner.returnExecuteQueryStrings("tlsp:validateAccess('"+sessionID+"','2.19','Delete')");
