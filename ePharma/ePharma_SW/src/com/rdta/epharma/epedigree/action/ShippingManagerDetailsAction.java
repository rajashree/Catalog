	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try{
			...
			if(name != null && name.equalsIgnoreCase("pedDetails") && pedType.equalsIgnoreCase("Shipped-Received")){
				pedt="tlsp:ShippedORReceivedPedigreeDetails('ShippedPedigree','"+pedigreeid+"','"+pid+"')";
			}else if(pedType != null && pedType.equalsIgnoreCase("Shipped-Initial")) 
				pedt="tlsp:InitialPedigreeDetails('ShippedPedigree','"+pedigreeid+"','"+envid+"')"; 
			else
				pedt="tlsp:ShippingPedigreeDetails('"+pedigreeid+"')";
