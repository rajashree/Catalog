...
function load(){
var stat = typeof(window.opener);

if(stat == "object"){
	
window.opener.location.href=self.location;
self.close();
}
return true;
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      ...
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>	   
          <td style="font-family:arial,sans-serif; font-size:13px; color:red; font-weight:700; text-decoration:none"><li>SessionTimedOut</li></td>
          </tr>
