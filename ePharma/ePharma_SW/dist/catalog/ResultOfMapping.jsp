...
<table width="100%" cellSpacing="0" cellPadding="0" align="left" border="0"
			bgcolor="white">
                ...
                <tr>
                <td><a href="ViewMappedDetails.do" target="_blank">View Details</a> </td>
                <td><a href="ViewExceptionDetails.do" target="_blank">View Details</a></td>
                </tr>
                
                 <tr>
                <td><input type="button" name="cancel" value="Cancel" onClick="window.location='Catalog.do?operationType=FIND&catalogGenId=<%=session.getAttribute("catalogGenId")%>'"/> </td>
                <td><input type="button" name="cancel" value="Save As Mapped" onClick="window.location='SaveMappingValues.do'"/></td>
                </tr>
