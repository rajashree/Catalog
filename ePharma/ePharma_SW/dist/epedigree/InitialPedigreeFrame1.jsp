...
if(s==false|| s1[i].value=="")
{
    ...
    function addLotInfo()
 {
	...
	newTD5.appendChild(  expirationDateName );
	newTD6.appendChild( expirationDate  );
                ...
                <tr> 
                  <td align="left">
					...
					<TR class="tableRow_Off">
						...
						<TD><html:text property="quantity" tabindex="8"   />
						</td>
					...
					<TD>* Strength :</TD>
						...
						<html:text property="strength"  tabindex="4"   />
						 ...
						 <TD>* Lot Number:</td>
						<TD><html:text property="lotNumber"  tabindex="9"  />		
						 </TD>
					...
					<TD colspan=6 >
						...
						<html:file property="attachment" tabindex="7"  />
