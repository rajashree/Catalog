...
<html:html>
	...
	<%
		...
		String mfrDetails = (String)request.getAttribute("mfrDetails");
		System.out.println("I am here................");
		
		String sessionID = (String)request.getAttribute("sessionId");
		
		System.out.println("sessionID in ePedigree_Show_Manufacturer_Detail.jsp is "+sessionID);
		...
		System.out.println("I am here second time........");
								...
								<td colspan="2">
									<table width="100%" id="Table2" cellSpacing="1" cellPadding="1" align="left" border="0"
										...
										<tr>
											<td colspan="5">
												<table border="1" cellpadding="1" cellspacing="1" width="100%">
														...
														<TD class="type-whrite"  bgcolor="gold" align="center"><STRONG><a href="ePedigree_Manager_Reconcile_Manufacturer.jsp?pedid=<%=APNID%>&tp_company_nm=<%=tp_company_nm%>&pagenm=pedigree&selpedid=<%=(String)session.getAttribute("PedigreeOrder")%>"><FONT color="#000099">Manufacturer(s)</FONT></a></STRONG>
														</TD>
										...
										<tr class="tableRow_On">
											<td class="td-menu bold">Manufacturer</td>
