...
function Alert()
{
 ...
 frm.action ="window.open('GenerateAlertAccess.do?sessionID=<%=sessionID%>&envelopeId=<%=envelopeId%>,'width=600,height=500')";
   frm.submit();
										...
										<TR class="tableRow_Header">
									       ...
									       <logic:notEqual name="envDetails" value="0">
												<logic:iterate name="<%=Constants.ENVELOPE_DETAILS%>" id="envd">
													<tr class="tableRow_Off">
														<td>
															<a href="PedigreeDetails.do?PedigreeId=<bean:write name="envd" property="pedigreeID"/>&pagenm=pedigree&tp_company_nm=<%=tp_company_nm%>&linkname=ShipSum">
															<bean:write name="envd" property="pedigreeID"/>
														</td>	
														<td>
							...
							<tr>
							  <TD colSpan="2"><BR>
									<!--<A onclick="MM_openBrWindow('PrintPedigree.jsp?apnId=','APN','scrollbars=yes,resizable=yes,width=800,height=600')"
										href="#"><IMG height="27" hspace="10" src="../../assets/images/print.gif" width="27" border="0"></A>--> 
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<INPUT  onClick="window.open('GenerateAlertAccess.do?sessionID=<%=sessionID%>&envelopeId=<%=envelopeId%>','apnwin','width=600,height=500')"
										type="button" value="Generate Envelope Alert" name="Button1">
	    					  </TD>
						 </tr>
			       </table>
			  </html:form>
