										...
										<tr>
											<td align="left">
												<table id="Table11" cellSpacing="1" cellPadding="1" width="100%" align="left" bgColor="white"
													...
													<html:form action="/dist/epedigree/PedigreeSearch.do?accesslevel=apnsearch"   method="post" >
														...
														<td align="left">
															...
															<table id="Table12" cellSpacing="1" cellPadding="0" width="100%" align="center" border="0">
																...
																<tr class="tableRow_Header">
																		...
																		<td class="type-whrite" noWrap align="center">PedigreeID</td>
																		<td class="type-whrite" noWrap align="center">EnvelopID</td>
																	...
																	<tr class="tableRow_Off">
																		<!-- <td class='td-content' height='20'>
																			...
																			<a href="PedigreeDetails.do?PedigreeId=<bean:write name="apn" property="pedigreeId"/>&pagenm=pedigree&tp_company_nm=<%=tp_company_nm%>&linkname=ShipSum">
																		</td> -->
																			
																		<td>
																		<a href="Shipping_PedigreeDetails.do?envId=<bean:write name="apn" property="envelopeId"/>&PedigreeId=<bean:write name="apn" property="pedigreeId"/>&pagenm=pedigree&tp_company_nm=<%=tp_company_nm%>&linkname=ShipSum">
																		<bean:write name="apn" property="pedigreeId"/>
																		</td>	
																		
																		<td class='td-content'>
																			<bean:write name="apn" property="envelopeId"/>
																		</td>
																		...
																		<td>
																			<bean:write name="apn" property="status"/>
																		</td>
																		
																		<td>
																			<bean:write name="apn" property="createdBy"/>
																		</td>
