...
%>
	...
	<div id="menu" style="Z-INDEX: 101">
		<table width="100%" height="25" border="0" cellpadding="0" cellspacing="0" ID="Table1">
			<tr>
				<td valign="middle" background="<%=servPath%>/assets/images/bg_menu.jpg"><table width="800" border="0" cellpadding="0" cellspacing="0" ID="Table2">
						<tr>
							<% if(pagenm.equals("epcadmin")) { %>
								...
								onmouseout="this.style.backgroundColor='';this.style.color=''"><a href="<%=servPath%>/AdminUser.do?pagenm=epcadmin&tp_company_nm=<%=tp_company_nm%>"" target="_parent">Admin Console</a></td>
							...
							<% if(pagenm.equals("pedigree")) { %>
								<td align="center" class="primaryNav_On" onmouseover="this.style.backgroundColor='#FFCC33';this.style.color='#FFFFFF'"
								onmouseout="this.style.backgroundColor='';this.style.color=''"><a href="<%=servPath%>/dist/epedigree/epedigree.do?pagenm=pedigree&tp_company_nm=<%=tp_company_nm%>&linkName=eped" class="menu-link menuBlack" target="_parent">ePedigree</a></td>
							<% } else { %>
								<td align="center" class="primaryNav_Off" onmouseover="this.style.backgroundColor='#FFCC33';this.style.color='#FFFFFF'"
								onmouseout="this.style.backgroundColor='';this.style.color=''"><a href="<%=servPath%>/dist/epedigree/epedigree.do?pagenm=pedigree&tp_company_nm=<%=tp_company_nm%>&linkName=eped" class="menu-link menuBlack" target="_parent">ePedigree</a></td>
							<% } %>						
							...
							<% if(pagenm.equals("reports")) { %>
								<td align="center" class="primaryNav_On" onmouseover="this.style.backgroundColor='#FFCC33';this.style.color='#FFFFFF'"
								onmouseout="this.style.backgroundColor='';this.style.color=''"><a href="<%=servPath%>/dist/reports/AdvancedReports.do?sessionID=<%=sessionID%>&tp_company_nm=<%=tp_company_nm%>&pagenm=reports" class="menu-link" target="_parent">Reports</a></td>
							<% } else { %>
								<td align="center" class="primaryNav_Off" onmouseover="this.style.backgroundColor='#FFCC33';this.style.color='#FFFFFF'"
								onmouseout="this.style.backgroundColor='';this.style.color=''"><a href="<%=servPath%>/dist/reports/AdvancedReports.do?sessionID=<%=sessionID%>&tp_company_nm=<%=tp_company_nm%>&pagenm=reports" class="menu-link" target="_parent">Reports</a></td>
							<% } %>
							...
							<% if(pagenm.equals("TPManager")) { %>
								<td align="center" class="primaryNav_On" onmouseover="this.style.backgroundColor='#FFCC33';this.style.color='#FFFFFF'"
								onmouseout="this.style.backgroundColor='';this.style.color=''"><a href="/ePharma/TradingPartnerList.do?tp_company_nm=<%=tp_company_nm%>&pagenm=TPManager" class="menu-link" target="_parent">Vendor Information Manager</a></td>
							<% } else { %>
								<td align="center" class="primaryNav_Off" onmouseover="this.style.backgroundColor='#FFCC33';this.style.color='#FFFFFF'"
								onmouseout="this.style.backgroundColor='';this.style.color=''"><a href="/ePharma/TradingPartnerList.do?tp_company_nm=<%=tp_company_nm%>&pagenm=TPManager" class="menu-link" target="_parent">Vendor Information Manager</a></td>
							<% } %>
	...
	<div id="leftgray2" style="Z-INDEX: 104">
		<table width="170" height="100%" border="0" cellpadding="0" cellspacing="0" ID="Table5">
			...
			<tr>
				...
				<td valign="top" class="td-left"><br>
					<a href="<%=servPath%>/dist/epedigree/ePedigree_ReceivingManager.do?pagenm=pedigree&tp_company_nm=<%=tp_company_nm%>&accesslevel=recvng&linkName=recvngmang" class=<%=(linkName.equals("recvngmang"))?"typered4-link":"typeblue3-link"%> >Receiving 
						Manager<br>
						<% if(linkName.equals("recvngmang") || linkName.equals("receivedFaxes") || linkName.equals("initial") || linkName.equals("processedFaxes") || linkName.equals("processedEnteredPedigrees")){ %>
					</a>&nbsp;&nbsp;
					<a href="<%=servPath%>/dist/epedigree/InitialPedigree.do?pagenm=pedigree&tp_company_nm=<%=tp_company_nm%>&linkName=initial" class=<%=(linkName.equals("initial"))?"typered4-link":"typeblue3-link"%> >Enter Pedigree 
						<%} %> 
						
						<% if(linkName.equals("recvngmang") || linkName.equals("processedFaxes") || linkName.equals("receivedFaxes") || linkName.equals("initial") || linkName.equals("processedEnteredPedigrees")){ %>
					</a><br>&nbsp;&nbsp;
					<a href="<%=servPath%>/dist/epedigree/ProcessedEnteredPedigrees.do?pagenm=pedigree&tp_company_nm=<%=tp_company_nm%>&linkName=processedEnteredPedigrees" class=<%=(linkName.equals("processedEnteredPedigrees"))?"typered4-link":"typeblue3-link"%> >Processed Pedigrees
                        <%} %> </a><br>
						
						<% if(linkName.equals("recvngmang") || linkName.equals("receivedFaxes") || linkName.equals("initial") || linkName.equals("processedFaxes") || linkName.equals("processedEnteredPedigrees")){ %>
					</a><br>&nbsp;&nbsp;
					<a href="<%=servPath%>/dist/epedigree/ReceivedFaxes.do?pagenm=pedigree&tp_company_nm=<%=tp_company_nm%>&linkName=receivedFaxes" class=<%=(linkName.equals("receivedFaxes"))?"typered4-link":"typeblue3-link"%> >Received Faxes
						<%} %> 
						
						<% if(linkName.equals("recvngmang") || linkName.equals("processedFaxes") || linkName.equals("receivedFaxes") || linkName.equals("initial") || linkName.equals("processedEnteredPedigrees")){ %>
					</a><br>&nbsp;&nbsp;
					<a href="<%=servPath%>/dist/epedigree/ProcessedFaxes.do?pagenm=pedigree&tp_company_nm=<%=tp_company_nm%>&linkName=processedFaxes" class=<%=(linkName.equals("processedFaxes"))?"typered4-link":"typeblue3-link"%> >Processed Faxes
						<%} %> 
					</a> 
					...
					<a href="../epedigree/PedigreeSearch.do?pagenm=pedigree&tp_company_nm=<%=tp_company_nm%>&accesslevel=apnsearch&linkName=apnsear" class=<%=(linkName.equals("apnsear"))?"typered4-link":"typeblue3-link"%>>Search Outgoing Pedigrees</a><br>
