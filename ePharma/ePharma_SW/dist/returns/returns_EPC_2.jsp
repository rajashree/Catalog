      ...
      <td><table border="0" cellspacing="0" cellpadding="0" width="100%">
		...
		<table width="100%" id="Table1" cellSpacing="1" cellPadding="1" align="left" border="0" bgcolor="white">
			...
			<tr>
				...
				<Tr>
					<Td colspan="2"><input name="Submit3" type="submit" class="fButton_xlarge" id="Submit2" onClick="MM_goToURL('parent','returns_EPC_3.jsp?sessionID=<%=sessionID%>&tp_company_nm=<%=tp_company_nm%>&pagenm=returns');return document.MM_returnValue" value="Print Serial ePedigree Labels"></Td>
				</Tr>
				</table></td>
					</tr>	
