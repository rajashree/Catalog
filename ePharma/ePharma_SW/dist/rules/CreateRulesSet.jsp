...
function deleteRule()
{
    ...
    frm.action = "CreateRuleSetAction.do?ruleSetID=<%=ruleSetID%>"
    frm.submit();
    return true;
...
{
    frm = document.forms[0]
    frm.action = "RS_RuleAction.do?ruleSetID=<%=ruleSetID%>"
    frm.submit();
    return true;
...
<FORM name="CreateRuleSetForm" ACTION="CreateRuleSetAction.do"  method="post" >
