	...
	<table align="center" border="1" cellspacing="1" cellpadding="1" width="90%">
		...
		<tr bgcolor="D3E5ED">
			<td>
				...
				<form name= "updateAndDelete" action="UpdateSchemaElementTree.do" method="post" target="_top"  >
					...
					<% if(!rootSelection) {%>
						...
						<tr>
							...
							<%
								if(isStandard ) {
							%>
									<input type="button"  value="Go Back" onClick="return goback('ProductMasterSearchEmpty.do')">

							<%
								} else {

							%>
								<input type="button"  value="Go Back" onClick="return goback('TPCatalogList.do')">
