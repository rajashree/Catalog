...
System.out.println(" catalogGenId in catalog schema def file   : " +  catalogId);


%>
<frameset border="1" rows="120,*" >
    <frame scrolling=auto name="top" src="./SchemaElementNewTop.do" />
	<frameset border="1" cols="230,*">	

		<frame scrolling=auto name="menu" src="./SchemaElementTree.do?catalogGenId=<%=catalogId%>&fromModule=<%=request.getParameter("fromModule")%> ">
		<frame scrolling=auto name="main" src="./SchemaElementEdit.do?catalogGenId=<%=catalogId%>&fromModule=<%=request.getParameter("fromModule") %>">
	</frameset>
</frameset>
