...
<FORM name= "CreateCatalogSchemaFromFile" ACTION="CreateCatalogSchemaFromFile.do"  method="post" enctype="multipart/form-data" >
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"> 
<INPUT id="hidden2" type="hidden" name="catalogGenId" value="<%= catalogGenId %>">
<INPUT id="hidden5" type="hidden" name="standardCatalogId" value="<%=standardCatalogId%>">
