...
%>
				...
				<tr class="tableRow_On"> 
                  <td  colspan="4" class="td-typeblack"> Trading Partner :<%=tpName%> </td>
					...
					<TR class="tableRow_On">
						<TD>*Location Name:</TD>
						<TD><INPUT id="Text1" value="<%= name %>" name="name" onclick="validate()"></TD>
						<TD>*Location GLN:</TD>
		...
		if(locationNode != null ) {
	%>  
				<Center><INPUT id="button" type="submit" value="UPDATE" onclick="return validate_Form()"> </Center>
           
           <%
           }else{
           %> 
           <Center><INPUT id="button" type="submit" value="Save" onclick="return validate_Form()"> </Center>
           <%
           }
           %>
				...
				<br>
           The fields marked with * are mandatory fields. </td>
        </tr>
      </table></div>
...
function validate_Form(){
  ...
  if(document.LocationForm.name.value == ""){  
  	...
  	document.LocationForm.name.focus();
  	valid = false;  
  }else 
  if(document.LocationForm.GLN.value == ""){  
  	alert("Please enter the GLN");
  	document.LocationForm.GLN.focus();
  	valid = false;  
  }else 
  if(document.LocationForm.GIAI.value == ""){  
  	alert("Please enter the GIAI");
  	document.LocationForm.GIAI.focus();
  	valid = false;  
  }else 
  if(document.LocationForm.GPS.value == ""){  
  	alert("Please enter the GPS");
  	document.LocationForm.GPS.focus();
  	valid = false;  
  }else 
  if(document.LocationForm.type.value == ""){  
  	alert("Please enter the type");
  	document.LocationForm.type.focus();
  	valid = false;  
  }else 
  if(document.LocationForm.event.value == ""){  
  	alert("Please enter the event");
  	document.LocationForm.event.focus();
  	valid = false;  
  }else 
  if(document.LocationForm.phone.value == ""){  
  	alert("Please enter the phone");
  	document.LocationForm.phone.focus();
  	valid = false;  
  }else 
  if(document.LocationForm.fax.value == ""){  
  	alert("Please enter the fax");
  	document.LocationForm.fax.focus();
  	valid = false;  
  }else 
  if(document.LocationForm.line1.value == ""){  
  	alert("Please enter the Address");
  	document.LocationForm.line1.focus();
  	valid = false;  
  }else 
  if(document.LocationForm.city.value == ""){  
  	alert("Please enter the city");
  	document.LocationForm.city.focus();
  	valid = false;  
  }else 
  if(document.LocationForm.state.value == ""){  
  	alert("Please enter the state");
  	document.LocationForm.state.focus();
  	valid = false;  
  }
  else 
  if(document.LocationForm.country.value == ""){  
  	alert("Please enter the country");
  	document.LocationForm.country.focus();
  	valid = false;  
  }
  else 
  if(document.LocationForm.zip.value == ""){  
  	alert("Please enter the zip");
  	document.LocationForm.zip.focus();
  	valid = false;  
  }
  else 
  if(document.LocationForm.inFormat.value == ""){  
  	alert("Please enter the inFormat");
  	document.LocationForm.inFormat.focus();
  	valid = false;  
  }
  else 
  if(document.LocationForm.outFormat.value == ""){  
  	alert("Please enter the outFormat");
  	document.LocationForm.outFormat.focus();
  	valid = false;  
  }
  
  
  if(valid == true){
  	 LocationAccessPrivilage();
  }else{
  	return false;
  }
}
