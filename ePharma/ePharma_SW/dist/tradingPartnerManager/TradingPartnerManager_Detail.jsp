...
<%
	...
	String zip = "";
	 ...
	 if(tradingPartnerNode != null ) {
		...
		title = CommonUtil.jspDisplayValue(tradingPartnerNode,"title");
                ...
                <tr> 
                  ...
                  <td class="title" colspan="4">Vendor Details</td>
					...
					<TR class="tableRow_On">
						<TD>* Name:</TD>
						<TD><INPUT id="Text1" value="<%= name %>" name="name" size="35"></TD>
						<TD>* Partner Type:</TD>
						<TD>
					...
					<TR class="tableRow_On">						
						...
						<TD>Title:</td>
						<TD><INPUT id="Text6" value="<%= title %>" name="title"></TD>
					</TR>
					<TR class="tableRow_Off">
						<TD>* Phone:</td>
...
function validate_Form(){
  ...
  if(document.TradingPartnerForm.partnerType.value == ""){
  	alert("Please enter the Partner Type");
  	document.TradingPartnerForm.partnerType.focus();
  	valid = false;  
  }else
  if(document.TradingPartnerForm.businessId.value == ""){
  	alert("Please enter the Business ID");
  	document.TradingPartnerForm.businessId.focus();
  	valid = false;  
  }else
  if(document.TradingPartnerForm.description.value == ""){
  	alert("Please enter the Description");
  		document.TradingPartnerForm.description.focus();
  	valid = false;  
  }else
  if(document.TradingPartnerForm.contact.value == ""){
  	alert("Please enter the Contact Name");
  	document.TradingPartnerForm.contact.focus();
  	valid = false;  
  }else
  if(document.TradingPartnerForm.phone.value == ""){
  	alert("Please enter the Phone Number");
  	document.TradingPartnerForm.phone.focus();
  	valid = false;  
  }else
  if(document.TradingPartnerForm.line1.value == ""){
  	alert("Please enter the Address1 Information");
  	document.TradingPartnerForm.line1.focus();
  	valid = false;  
  }else
  ...
  if(document.TradingPartnerForm.state.value == ""){
  	alert("Please enter the State");
  	document.TradingPartnerForm.state.focus();
  	valid = false;  
  }else
  if(document.TradingPartnerForm.country.value == ""){
  	alert("Please enter the Country");
  	document.TradingPartnerForm.country.focus();
  	valid = false;  
  }else
  if(document.TradingPartnerForm.zip.value == ""){
