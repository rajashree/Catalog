...
public class TLQueryRunner implements QueryRunner {
	...
	public String returnExecuteQueryStreamAsString(
	        String xquery, InputStream ins)
			throws PersistanceException {
		...
		try{
			...
			statement = conn.createStatement();
			statement.setQueryOption(QueryOption.XMLSPACE, "preserve");
			resultSet = statement.execute(xquery, ins);
			while(resultSet.next()){
				String s = resultSet.getString();
				buf.append(s);
    		}
	...
	public String returnExecuteQueryStreamAsStringNew(
			String xquery,Connection conn, InputStream ins)
			throws PersistanceException {
		...
		try{
			statement = conn.createStatement();
			statement.setQueryOption(QueryOption.XMLSPACE, "preserve");
			System.out.println("InputStream is :::"+ ins);
			resultSet = statement.execute(xquery, ins);
			while(resultSet.next()){
				String s = resultSet.getString();
				buf.append(s);
	...
	public List returnExecuteQueryWithStreamStringsNew(
	        String xquery,Connection conn, InputStream inputStream)
			throws PersistanceException {
		...
		try{
			...
			resultSet = statement.execute(xquery, inputStream);
			while(resultSet.next()){
				list.add(resultSet.getString());
    		}
	  	} catch (Exception ex) {
	 ...
	 * @param xquery
	 */
	public void executeQueryWithStream(
					String xquery, InputStream inputStream)
					throws PersistanceException {
