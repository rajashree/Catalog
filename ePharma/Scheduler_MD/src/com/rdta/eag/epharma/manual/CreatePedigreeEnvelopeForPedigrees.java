...
public class CreatePedigreeEnvelopeForPedigrees {
	...
	public static String preparePedigreeEnvelope(String xmlNode, String destRoutingCode) throws Exception{
		...
		//System.out.println("***Inside method preparePedigreeEnvelope******");
		StringBuffer buff = new StringBuffer();
		String envId = "";
		try{
		buff.append("tlsp:createPedigreeEnvelope_Manual("+xmlNode+",'"+destRoutingCode+"')");
		...
		for(int m=0;m<data.size();m++){
			...
			String query = "tlsp:InsertShippedPedigreeNew("+XMLUtil.convertToString(ele,true)+")";
