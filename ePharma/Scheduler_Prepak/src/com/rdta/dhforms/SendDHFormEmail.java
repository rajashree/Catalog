...
//          Send the message
	...
	public static String sendDHFormEmailAttachementToMultipleRecipients(
            String emailFrom, String emailTo[], 
            String smtpServer,  String emailSubject, 
            String emailMessage, String uName, String pwd,String filepath) throws Exception{
...
//          Define message
            ...
            for(int k=0;k<emailTo.length;k++){
         	   address = new InternetAddress(emailTo[k]);
...
//          Send the message
   ...
   public static void sendMailToMultipleRecipients(String emailFrom, String emailTo[], 
		   								 String smtpServer,  String emailSubject, 
       ...
       SMTP_AUTH_USER = uName; 
       SMTP_AUTH_PWD = pwd;
	System.out.println("Inside sendMailToSupport");
	//String[] toAddress = {"manish@rainingdata.com","venu.gopal@sourcen.com"};
       try{
           Properties props = new Properties();
           props.setProperty("mail.smtp.host",smtpServer);
           props.put("mail.debug", "true");
           ...
           ///msg.setRecipients(Message.RecipientType.TO, address);
           System.out.println("length of receipeints : "+msg.getAllRecipients().length);
           msg.setSubject(emailSubject);
           msg.setSentDate(new Date());
//            Create the message part 
           BodyPart messageBodyPart = new MimeBodyPart();
