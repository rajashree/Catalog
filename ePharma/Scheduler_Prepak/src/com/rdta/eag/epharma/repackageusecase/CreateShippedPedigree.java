...
public class CreateShippedPedigree {
	...
	public static String CreateShippedPed(String prevPed,String xmlString, String signerid, String deaNumber,String loopDocURI) throws Exception{
		...
		try{
			...
			qtoInsert = "tlsp:CreateShippedPedigreeForRepackage("+prevPed+","+xmlString+",'"+signerid+"','"+deaNumber+"','"+loopDocURI+"')";
