...
public void send(String smtpHost, String smtpPort, String from, String to, String pass, String subject, String content, 
     ...
     throws AddressException, MessagingException
 {
	System.out.println("***** Sending mail ***** ");
     ...
     Authenticator auth = new SMTPAuthenticatorNew(from, pass);
...
private class SMTPAuthenticatorNew extends Authenticator
{
    ...
    SMTPAuthenticatorNew(String userName, String password)
    {
    	System.out.println("Inside SMTPAuthenticatorNew");
