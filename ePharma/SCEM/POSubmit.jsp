...
<TR><TD>
	...
	<%		
	    ...
	    String XQuery="let $x :=(for $i in collection('tig:///Buyer/PO')/POI return $i)";
		...
		try
		{
    		...
    		while(rs.next())
    		{
				...
				try
				{
				    ...
				    {	      
				    	out.println("<TR   bgcolor=LightGrey class=tablefont2><form id='POSubmit' name='POSubmit' action='./ControlServlet' method='post'>");   					
		    			...
		    			out.println("<input type='hidden' value='POSubmit' id='controller' name='controller'>");
				        ...
				        out.println("<input type=submit value='Submit' id='Submit' name='Submit'></form></td>");
