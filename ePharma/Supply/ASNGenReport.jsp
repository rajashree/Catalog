...
<%@include file="SellerNav.jsp" %>
   <h1 align="center"><font size=10>ASN Genaretion Report</font></h1>
      <table align="center" border=2 width=50%>
      <th align=right>ConsignmentID</th><th align=right>OrderID</th><th align=right>ShipmentDate</th><th align=right>ItemID</th><th align=right>ItemDescription</th><th align=right>ItemQuantity</th><th align=right>ItemPrice</th>
...
<% 
  ...
  r=response;
  ses=session;
String conid="",itemid="",itemqty="",item_price="";
		  String poid="";
		  String date="";
         	 String item_desc="";
		 String stat="uncheck";
  ...
  xQuery ="for $b in collection('tig:///SELLER/ASN')/ASNI ";
				...
				if(nodename.equals("ASN"))
				{
					...
					for(int j=0;j<usrchlnodes.getLength();j++)
					{
						...
						if(userchildnode!=null)
						{
							...
							if(nodename.equals("ConsignmentID"))
														
								conid=userchildnode.getFirstChild().getNodeValue();

							if(nodename.equals("OrderID"))
								poid=userchildnode.getFirstChild().getNodeValue();

							if(nodename.equals("ShipmentDate"))
...
if(nodename.equals("ItemDescription"))
...
<tr>
       <td><% w.println(conid); %></td><td><% w.println(poid); %></td>
